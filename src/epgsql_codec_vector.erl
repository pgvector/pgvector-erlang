...
decode(Bin, vector, _) ->
    <<Dim:1/big-signed-unit:16, _Unused:1/big-signed-unit:16, Data:(Dim * 4)/binary>> = Bin,
    [V || <<V:1/big-float-unit:32>> <= Data];
decode(Bin, halfvec, _) ->
    <<Dim:1/big-signed-unit:16, _Unused:1/big-signed-unit:16, Data:(Dim * 2)/binary>> = Bin,
